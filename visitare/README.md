...
- visitare-widgetset: widgetset, custom client side code and dependencies to widget add-ons
- visitare-ui: main application module, development time
- visitare-production: module that produces a production mode WAR for deployment
